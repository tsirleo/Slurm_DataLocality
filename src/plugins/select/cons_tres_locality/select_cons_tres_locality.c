/*****************************************************************************\
 *  select_cons_tres_locality.c - Resource selection plugin supporting Trackable
 ...
 */
const char plugin_name[] = "Trackable RESources (TRES) Selection plugin + Alluxio Datasource dir tracking";
const char plugin_type[] = "select/cons_tres_locality";
const uint32_t plugin_id      = SELECT_PLUGIN_CONS_TRES_LOCALITY;
